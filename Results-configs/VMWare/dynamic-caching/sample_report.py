...
def is_correct(msg):
	...
	if 'After Recovery:: Unmountable even after repair!' in msg:
		...
		#For cache enable disks, durability violation is not a bug.	
		...
		,'First durability signal present - Violated durability!', 'Second durability signal present - Violated durability!']
