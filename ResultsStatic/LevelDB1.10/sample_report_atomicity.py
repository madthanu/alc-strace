...
def meaning(x):
	...
	elif 'Corruption: bad record length' in x or 'Corruption: checksum mismatch' in x or 'Corruption: error in middle of record' in x or 'Corruption: missing start of fragmented record' in x or 'Corruption: partial record without end' in x or 'Corruption: truncated record at end of file' in x:
