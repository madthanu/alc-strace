...
def failure_category(msg):
    ...
    if errors is not '':
        ...
        toret.append("Dirstate corruption")    
        return toret
    else:
...
def is_correct(msg):
    ...
    if 'RMA' in errors or 'RP' in errors:
    	return True

    if 'SI,' == errors or 'SI,RMBfile5,PDB,' == errors or 'SI,RMBfile5,RMBfilerm,PDB,' == errors or 'SI,RMBfile5,RMBfilerm,' == errors or 'SI,RMBfile5,' == errors or 'SI,RMBfilerm,' == errors:
    	return False    	
    else:
        return True
