...
def failure_category(msg):
    ...
    if errors is not '':
        ...
        toret.append("Repository Corruption")
        return toret
    else:
...
def is_correct(msg):
    ...
    if 'SI,' == errors or 'SI,RMBfile5,PDB,' == errors or 'SI,RMBfile5,RMBfilerm,PDB,' == errors or 'SI,RMBfile5,RMBfilerm,' == errors or 'SI,RMBfile5,' == errors or 'SI,RMBfilerm,' == errors or errors == 'RMBfile5,' or errors == 'RMBfile5,PDB,' or errors == 'RMBfilerm,' or errors is '':
        return True
    else:
        return False
