...
def is_correct(msg):
    ...
    if 'SI,RMBfile5,PDB,' == errors or 'SI,RMBfile5,RMBfilerm,PDB,' == errors or 'SI,RMBfile5,RMBfilerm,' == errors or 'SI,RMBfile5,' == errors or 'SI,RMBfilerm,' == errors or errors == 'RMBfile5,' or errors == 'RMBfile5,PDB,' or errors == 'RMBfilerm,' or errors is '':
        return True
    else:
        return False
        
error_reporter.report_errors('###', os.getenv('ALC_STRACE_HOME') + '/Results/merc.auto/strace_description', os.getenv('ALC_STRACE_HOME') + '/Results/merc.auto/replay_output', is_correct, failure_category = failure_category)
